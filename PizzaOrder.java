...
public class PizzaOrder
{
   public static void main (String[] args)
   {
      ...
      double cost = 12.99, total;          // Cost of the pizza/ total cost of pizza
      ...
      if (firstName.equals("Mike") || firstName.equals("Diane")|| firstName.equals("mike") || firstName.equals("diane"))
   	  {
    	  discount = true;
      ...
      System.out.println("The default pizza size is 12 inches, so you get a 12 inch pizza. " );
      cost = 12.99;
      ...
      {
      cost = cost - 2.00;
      System.out.println("Great you got a $2.00 discount!!!");
      }
      tax = cost * (TAX_RATE);
